...
export type HairColor =
	| 'Black' | 'White' | 'Blonde' | 'Brown' | 'Red'
	| 'Blue' | 'Green' | 'Pink' | 'Purple' | 'Multicolor';

export type EyeColor =
	| 'Black' | 'Brown' | 'Red' | 'Blue' | 'Green'
	| 'Purple' | 'Yellow' | 'Pink' | 'White' | 'Multicolor';

export type Developer =
	| 'HoYoverse' | 'Yostar' | 'Nexon' | 'Kuro Games' | 'Cygames' | 'Other';

export type HeightCategory = 'Short' | 'Average' | 'Tall';

export type OutfitColor =
	| 'Black' | 'White' | 'Red' | 'Blue' | 'Green'
	| 'Purple' | 'Yellow' | 'Pink' | 'Brown' | 'Multicolor';
