/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: d2e47f77f483b4523ce18cadc0ea91fe)
// Runtime types generated with workerd@1.20260601.1 2026-06-04 nodejs_als,nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	WALLETDLE_SECRET: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, 'WALLETDLE_SECRET'>> {}
}
